...
function Fun() {
    const sentences = [
        ...
        "At a friend's party, I played with a band.",
    ...
    const checkTyping = (e: KeyboardEvent) => {
        ...
        const color = currentChar === e.key ? 'text-primary' : 'text-terciary-light'
    ...
    return (
        <div className="p-5 gap-5 flex flex-col justify-center text-center">
            ...
            <p>
                Easy! Just click the textarea below and start typing the sentence shown above.
                Click outside the textarea whenever you want to stop.
            </p>
